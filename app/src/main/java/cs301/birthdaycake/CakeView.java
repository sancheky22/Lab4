...
public class CakeView extends SurfaceView {
    ...
    public static final float layerHeight = 201.0f;
    ...
    public void onDraw(Canvas canvas)
    {
        ...
        for (int i = 0; i < this.cake_model.numCandles; i++) {
            drawCandle(canvas, cakeLeft + cakeWidth / (this.cake_model.numCandles) - candleWidth / (this.cake_model.numCandles) - 80 + 100*i, cakeTop);
        }
